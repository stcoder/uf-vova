...
Column::register('published', '\App\Columns\Published');
Column::register('option_value', '\App\Columns\OptionValue');

FormItem::register('option_value', '\App\FormItem\OptionValue');