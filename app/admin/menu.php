...
Admin::menu('\App\Option')->label('Опции')->icon('fa-cogs');
Admin::menu('\App\Page')->label('Страницы')->icon('fa-file-text');
Admin::menu('\App\Slide')->label('Слайды')->icon('fa-file-image-o');